// Questions for each emotion (3 questions per emotion)
...
// Get random question for an emotion
export function getRandomQuestion(emotionId: string): string {
  const questions = emotionQuestions[emotionId]
...
// Get all questions for an emotion
export function getQuestionsForEmotion(emotionId: string): string[] {
  return emotionQuestions[emotionId] || []
}
